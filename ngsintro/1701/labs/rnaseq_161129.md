...
{% highlight bash %}
salloc -A g2016035 -t 08:00:00 -p core -n 8 --no-shell --reservation=g2016028_THU &
{% endhighlight %} 
</details>  
<details>
<summary>:key: Click to see how to book a node on Friday</summary>
{% highlight bash %}
salloc -A g2016028 -t 08:00:00 -p core -n 8 --no-shell --reservation=g2016028_FRI &
{% endhighlight %} 
</details>  
<br />
...
{% highlight bash %}
cd /proj/b2016035/nobackup/<username>/<username>
mkdir transcriptome
...
<summary>:key: Click to see suggested commands</summary>
{% highlight bash %}
cd /proj/b2016035/nobackup/<username>/transcriptome
mkdir fastqc
cd fastqc
{% endhighlight %} 
</details>  
...
<summary>:key: Click to see suggested commands</summary>
{% highlight bash %}
for i in /proj/b2016035/nobackup/<username>/transcriptome/DATA/* 
do 
fastqc $i -o /proj/b2016035/nobackup/<username>/transcriptome/fastqc/ 
done
{% endhighlight %}
</details>  
<br />
...
{% highlight bash %}
mkdir /proj/b2016035/nobackup/<username>/transcriptome/reference
{% endhighlight %}
</details>  
<br />
...
{% highlight bash %}
cd /proj/b2016035/nobackup/<username>/transcriptome/reference
...
{% highlight bash %}
mkdir /proj/b2016035/nobackup/<username>/transcriptome/indexChr11
cd /proj/b2016035/nobackup/<username>/transcriptome/indexChr11
{% endhighlight %}
</details>  
<br />
...
{% highlight bash %}
star --runMode genomeGenerate --runThreadN 8 --genomeDir /proj/b2016035/nobackup/<username>/transcriptome/indexChr11 --genomeFastaFiles /proj/b2016035/nobackup/<username>/transcriptome/reference/Mus_musculus.GRCm38.dna.chromosome.11.fa --sjdbGTFfile /proj/b2016035/nobackup/<username>/transcriptome/reference/Mus_musculus.GRCm38.85.gtf
{% endhighlight %}
</details>
<br />
...
{% highlight bash %}
mkdir /proj/b2016035/nobackup/<username>/transcriptome/star
mkdir /proj/b2016035/nobackup/<username>/transcriptome/star/SRR3222409
{% endhighlight %}
</details>
<br />
...
<details>
 ...
 {% highlight bash %}
 star --genomeDir /proj/b2016035/nobackup/<username>/transcriptome/index/complete --readFilesIn /proj/b2016035/nobackup/<username>/transcriptome/DATA/SRR3222409_1.fastq.gz /proj/b2016035/nobackup/<username>/transcriptome/DATA/SRR3222409_2.fastq.gz --runThreadN 8 --readFilesCommand zcat --outFileNamePrefix /proj/b2016035/nobackup/<username>/transcriptome/star/SRR3222409/SRR3222409_
 {% endhighlight %}
 </details>
<br />
...
{% highlight bash %}
cp -r /sw/courses/ngsintro/rnaseq/main/star/SRR3222410/ /proj/b2016035/nobackup/<username>/transcriptome/star/
{% endhighlight %}
</details>
...
do
cp -r /sw/courses/ngsintro/rnaseq/main/star/$i /proj/b2016035/nobackup/<username>/transcriptome/star/
done
{% endhighlight %}
</details>
<br />
...
{% highlight bash %}
mkdir /proj/b2016035/nobackup/<username>/transcriptome/bams
cd /proj/b2016035/nobackup/<username>/transcriptome/bams 
...
{% highlight bash %}
ln -s /proj/b2016035/nobackup/<username>/transcriptome/star/SRR3222409/SRR3222409_Aligned.out.sam
{% endhighlight %}
</details>
<details>
<summary>:key: Click to see the suggested commands, using bash loop</summary>
{% highlight bash %}
for i in /proj/b2016035/nobackup/<username>/transcriptome/star/**/*.sam 
do ln -s $i
done
{% endhighlight %}
</details>
...
{% highlight bash %}
cp /sw/courses/ngsintro/rnaseq/main/bams/out/SRR3222410_Aligned.out.bam /proj/b2016035/nobackup/<username>/transcriptome/bams/
{% endhighlight %}
</details>
<details>
...
{% highlight bash %}
for i in SRR3222411 SRR3222412 SRR3222413 SRR3222414
do cp "/sw/courses/ngsintro/rnaseq/main/bams/out/"$i"_Aligned.out.bam" /proj/b2016035/nobackup/<username>/transcriptome/bams/ 
done
{% endhighlight %}
</details>
<br />
...
{% highlight bash %}
samtools sort -o /proj/b2016035/nobackup/<username>/transcriptome/bams/SRR3222409_Aligned.out.sorted.bam -T sort_temp /proj/b2016035/nobackup/<username>/transcriptome/bams/SRR3222409_Aligned.out.bam
{% endhighlight %}
</details>
<br />
...
<summary>:key: Click to see how to copy over sample by sample</summary>
{% highlight bash %}
cp /sw/courses/ngsintro/rnaseq/main/bams/out/SRR3222410_Aligned.out.sorted.bam /proj/b2016035/nobackup/<username>/transcriptome/bams/
{% endhighlight %}
</details>
<details>
...
{% highlight bash %}
for i in SRR3222411 SRR3222412 SRR3222413 SRR3222414 
do cp "/sw/courses/ngsintro/rnaseq/main/bams/out/"$i"_Aligned.out.sorted.bam" /proj/b2016035/nobackup/<username>/transcriptome/bams/
done
{% endhighlight %}
</details>
<br />
...
{% highlight bash %}
samtools index /proj/b2016035/nobackup/<username>/transcriptome/bams/SRR3222410_Aligned.out.sorted.bam
{% endhighlight %}
</details>
<details>
<summary>:key: Click to see how to index BAM file, using bash loop</summary>
{% highlight bash %}
for i in  /proj/b2016035/nobackup/<username>/transcriptome/bams/*.sorted.bam
do samtools index $i
done
{% endhighlight %}
</details>
...
<summary>:key: Click to see the suggested commands</summary>
{% highlight bash %}
mkdir /proj/b2016035/nobackup/<username>/transcriptome/qualimap 
cd /proj/b2016035/nobackup/<username>/transcriptome/qualimap/
...
<summary>:key: Click to see the suggested commands</summary>
{% highlight bash %}
qualimap rnaseq -pe -bam /proj/b2016035/nobackup/<username>/transcriptome/bams/SRR3222409_Aligned.out.sorted.bam -gtf /proj/b2016035/nobackup/<username>/rnaseq_tst/trx/reference/Mus_musculus.GRCm38.85.gtf --outdir /proj/b2016035/nobackup/<username>/rnaseq_tst/trx/qualimap/SRR3222409 --java-mem-size=63G > /dev/null 2>&1
{% endhighlight %}
</details>
<br />
...
{% highlight bash %}
cp -r /sw/courses/ngsintro/rnaseq/main/qualimap/SRR3222410 /proj/b2016035/nobackup/<username>/transcriptome/qualimap/
{% endhighlight %}
</details>
<details>
...
do cp -r "/sw/courses/ngsintro/rnaseq/main/qualimap"/$i /proj/b2016035/nobackup/<username>/transcriptome/qualimap/
done
{% endhighlight %}
</details>
<br />
...
<summary>:key: Click to see how...</summary>
{% highlight bash %}
mkdir /proj/b2016035/nobackup/<username>/transcriptome/featurecounts
cd /proj/b2016035/nobackup/<username>/transcriptome/featurecounts
{% endhighlight %}
</details>
<br />
...
{% highlight bash %}
featureCounts -p -a /proj/b2016035/nobackup/<username>/transcriptome/reference/Mus_musculus.GRCm38.85.gtf -t gene -g gene_id -s 0 -o tableCounts *.sam
{% endhighlight %}
</details>
<br />
...
<summary>:key: Click to see how </summary>
{% highlight bash %}
mkdir /proj/b2016035/nobackup/<username>/transcriptome/DE 
cd /proj/b2016035/nobackup/<username>/transcriptome/DE
{% endhighlight %}
</details>
<br />
...
<summary>:key: Click to see how </summary>
{% highlight bash %}
ln -s /proj/b2016035/nobackup/<username>/transcriptome/featurecounts/tableCounts
...
lrwxrwxrwx 1 olga olga   55 Nov 29 16:30 tableCounts -> /home/olga/glob/transcriptome/featurecounts/tableCounts
...
<summary>:key: Click to see an example of a command</summary>
{% highlight bash %}
cp -r /sw/courses/ngsintro/rnaseq/bonus/funannot/ /proj/b2016035/nobackup/<username>/transcriptome/
{% endhighlight %}
</details>
<br />
...
<summary>:key: Click to see how</summary>
{% highlight bash %}
cd /proj/b2016035/nobackup/<username>/transcriptome/funannot
{% endhighlight %}
</details>
<br />
...
<summary>:key: Click to see an example of a command</summary>
{% highlight bash %}
cp -r /sw/courses/ngsintro/rnaseq/bonus/exon /proj/b2016035/nobackup/<username>/transcriptome
{% endhighlight %}
</details>
<br />
...
<summary>:key: Click to see how</summary>
{% highlight bash %}
cd /proj/b2016035/nobackup/<username>/transcriptome/exon
{% endhighlight %}
</details>
<br />
...
{% highlight bash %}
scp username@milou.uppmax.uu.se:/proj/b2016035/nobackup/<username>/transcriptome/bamfile.bam .
{% endhighlight %}
...
{% highlight bash %}
scp username@milou.uppmax.uu.se:/proj/b2016035/nobackup/<username>/transcriptome/DE/coverage.pdf .
{% endhighlight %}
...
mkdir /proj/b2016035/nobackup/<username>/transcriptome/trinity
cp /sw/courses/ngsintro/rnaseq/bonus/denovo/*.fasta /proj/b2016035/nobackup/<username>/transcriptome/trinity/
{% endhighlight %}
</details>
<br />
