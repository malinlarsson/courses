...
{% highlight bash %}
cd /proj/g2016035/nobackup/<username>/<username>
mkdir transcriptome
...
<summary>:key: Click to see suggested commands</summary>
{% highlight bash %}
for i in /proj/g2016035/nobackup/<username>/transcriptome/DATA/* 
do 
  fastqc $i -o /proj/g2016035/nobackup/<username>/transcriptome/fastqc/ 
done
{% endhighlight %}
</details>  
<br />
...
{% highlight bash %}
mkdir /proj/g2016035/nobackup/<username>/transcriptome/reference
{% endhighlight %}
</details>  
<br />
...
{% highlight bash %}
cd /proj/g2016035/nobackup/<username>/transcriptome/reference
...
{% highlight bash %}
ll -h /proj/g2016035/nobackup/<username>/transcriptome/reference/
...
{% highlight bash %}
mkdir /proj/g2016035/nobackup/<username>/transcriptome/indexChr11
cd /proj/g2016035/nobackup/<username>/transcriptome/indexChr11
{% endhighlight %}
</details>  
<br />
...
{% highlight bash %}
ll -h /proj/g2016035/nobackup/<username>/transcriptome/indexChr11
...
{% highlight bash %}
mkdir /proj/g2016035/nobackup/<username>/transcriptome/star
mkdir /proj/g2016035/nobackup/<username>/transcriptome/star/SRR3222409
{% endhighlight %}
</details>
<br />
...
<details>
 ...
 {% highlight bash %}
 star --genomeDir /proj/g2016035/nobackup/<username>/transcriptome/index/complete --readFilesIn /proj/g2016035/nobackup/<username>/transcriptome/DATA/SRR3222409_1.fastq.gz /proj/g2016035/nobackup/<username>/transcriptome/DATA/SRR3222409_2.fastq.gz --runThreadN 8 --readFilesCommand zcat --outFileNamePrefix /proj/g2016035/nobackup/<username>/transcriptome/star/SRR3222409/SRR3222409_
 {% endhighlight %}
 </details>
<br />
...
{% highlight bash %}
mkdir /proj/g2016035/nobackup/<username>/transcriptome/bams
cd /proj/g2016035/nobackup/<username>/transcriptome/bams 
...
{% highlight bash %}
for i in /proj/g2016035/nobackup/<username>/transcriptome/star/**/*.sam 
  do ln -s $i
done
{% endhighlight %}
</details>
...
{% highlight bash %}
ll -h  /proj/g2016035/nobackup/<username>/transcriptome/bams/*.sam
...
{% highlight bash %}
ll -h  /proj/g2016035/nobackup/<username>/transcriptome/bams/*.bam
...
{% highlight bash %}
samtools sort -o /proj/g2016035/nobackup/<username>/transcriptome/bams/SRR3222409_Aligned.out.sorted.bam -T sort_temp /proj/g2016035/nobackup/<username>/transcriptome/bams/SRR3222409_Aligned.out.bam
{% endhighlight %}
</details>
<br />
...
{% highlight bash %}
ll -h  /proj/g2016035/nobackup/<username>/transcriptome/bams/*.sorted.bam
...
{% highlight bash %}
samtools index /proj/g2016035/nobackup/<username>/transcriptome/bams/SRR3222410_Aligned.out.sorted.bam
{% endhighlight %}
</details>
<details>
<summary>:key: Click to see how to index BAM file, using bash loop</summary>
{% highlight bash %}
for i in  /proj/g2016035/nobackup/<username>/transcriptome/bams/*.sorted.bam
  do samtools index $i
done
{% endhighlight %}
</details>
...
{% highlight bash %}
ll -h  /proj/g2016035/nobackup/<username>/transcriptome/bams/*.bai
...
<summary>:key: Click to see the suggested commands</summary>
{% highlight bash %}
mkdir /proj/g2016035/nobackup/<username>/transcriptome/qualimap 
cd /proj/g2016035/nobackup/<username>/transcriptome/qualimap/
module load QualiMap/2.2
{% endhighlight %}
</details>
<br />

:computer: **Run QualiMap** for the fist sample on sorted BAM file *SRR3222409\_Aligned.out.sorted.bam* **directing** the results to */proj/g2016035/nobackup/<username>/transcriptome/qualimap/SRR3222409* folder. :bulb: QualiMap creates the folder if you specify the right parameter
<details>
<summary>:key: Click to see the suggested commands</summary>
{% highlight bash %}
qualimap rnaseq -pe -bam /proj/g2016035/nobackup/<username>/transcriptome/bams/SRR3222409_Aligned.out.sorted.bam -gtf /proj/g2016035/nobackup/<username>/transcriptome/reference/Mus_musculus.GRCm38.85.gtf --outdir /proj/g2016035/nobackup/<username>/transcriptome/qualimap/SRR3222409 --java-mem-size=63G > /dev/null 2>&1
{% endhighlight %}
</details>
<br />
...
{% highlight bash %}
ll -h /proj/g2016035/nobackup/<username>/transcriptome/qualimap/SRR3222409/
...
<summary>:key: Click to see how...</summary>
{% highlight bash %}
mkdir /proj/g2016035/nobackup/<username>/transcriptome/featurecounts
cd /proj/g2016035/nobackup/<username>/transcriptome/featurecounts
{% endhighlight %}
</details>
<br />
...
:computer: **Sym-link** SAM files generated by Star and located in */proj/g2016035/nobackup/<username>/transcriptome/star*
<details>
...
{% highlight bash %}
featureCounts -p -a /proj/g2016035/nobackup/<username>/transcriptome/reference/Mus_musculus.GRCm38.85.gtf -t gene -g gene_id -s 0 -o tableCounts *.sam
{% endhighlight %}
</details>
<br />
...
{% highlight bash %}
ll -h /proj/g2016035/nobackup/<username>/transcriptome/DE/table*
...
<summary>:key: Click to see how </summary>
{% highlight bash %}
mkdir /proj/g2016035/nobackup/<username>/transcriptome/DE 
...
<summary>:key: Click to see how</summary>
{% highlight bash %}
cd /proj/g2016035/nobackup/<username>/transcriptome/funannot
{% endhighlight %}
</details>
<br />
...
<summary>:key: Click to see how</summary>
{% highlight bash %}
cd /proj/g2016035/nobackup/<username>/transcriptome/exon
{% endhighlight %}
</details>
<br />
...
{% highlight bash %}
scp username@milou.uppmax.uu.se:/proj/g2016035/nobackup/<username>/transcriptome/bamfile.bam .
{% endhighlight %}
...
{% highlight bash %}
scp username@milou.uppmax.uu.se:/proj/g2016035/nobackup/<username>/transcriptome/DE/coverage.pdf .
{% endhighlight %}
