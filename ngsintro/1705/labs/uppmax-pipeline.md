...
$ salloc -A g2017014 -t 04:30:00 -p core -n 1 --no-shell --reservation=g2017014_mon &
```
...
$ cp -r /sw/courses/ngsintro/uppmax_pipeline_exercise/data /proj/g2017014/nobackup/<username>/uppmax_pipeline_exercise
```

Have a look in `/proj/g2017014/nobackup/<username>/uppmax_pipeline_exercise`:

```bash
$ cd /proj/g2017014/nobackup/<username>/uppmax_pipeline_exercise
...
```bash
$ cd /proj/g2017014/nobackup/<username>/uppmax_pipeline_exercise/exomeSeq
```
