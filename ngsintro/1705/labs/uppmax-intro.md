...
$ cp -r /sw/courses/ngsintro/uppmax_tutorial /proj/g2017014/nobackup/<username>
```

Have a look in **/proj/g2017014/nobackup/\<username\>/uppmax_tutorial**:

```bash
$ cd /proj/g2017014/nobackup/<username>/uppmax_tutorial
...
```bash
$ interactive -A g2017014 -t 02:00:00 -p core
```
