...
```bash
$ salloc -A g2017029 -t 02:00:00 -p core -n 1 --no-shell --reservation=g2017029_TUE &
```
...
$ cp -r /sw/courses/ngsintro/filetypes /proj/g2017029/nobackup/<username>/
```

Have a look in **/proj/g2017029/nobackup/\<username\>/:**

```bash
$ cd /proj/g2017029/nobackup/<username>/filetypes
$ tree
```
