...
```bash
$ interactive -A g2017029 -t 05:00:00 -p core -n 1
```
...
$ mkdir /proj/g2017029/nobackup/<username>/uppmax_tutorial
```

or

```bash
$ mkdir -p /proj/g2017029/nobackup/<username>/uppmax_tutorial
```
...
$ cp -r /sw/courses/ngsintro/uppmax_tutorial/* /proj/g2017029/nobackup/<username>/uppmax_tutorial
```
...
Have a look in **/proj/g2017029/nobackup/\<username\>/uppmax_tutorial**:

```bash
$ cd /proj/g2017029/nobackup/<username>/uppmax_tutorial
