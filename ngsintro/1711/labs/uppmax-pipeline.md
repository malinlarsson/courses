...
$ salloc -A g2017029 -t 04:30:00 -p core -n 1 --no-shell --reservation=g2017029_MON &
```
...
$ cp -r /sw/courses/ngsintro/uppmax_pipeline_exercise/data /proj/g2017029/nobackup/<username>/uppmax_pipeline_exercise
```

Have a look in `/proj/g2017029/nobackup/<username>/uppmax_pipeline_exercise`:

```bash
$ cd /proj/g2017029/nobackup/<username>/uppmax_pipeline_exercise
...
```bash
$ cd /proj/g2017029/nobackup/<username>/uppmax_pipeline_exercise/exomeSeq
```
