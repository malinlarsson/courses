...
{% highlight bash %}
salloc -A g2018018 -t 08:00:00 -p core -n 4 --reservation=g2018018_THU
{% endhighlight %} 
</details>  
<details>
<summary>:key: Click to see how to book a node on Friday</summary>
{% highlight bash %}
salloc -A g2018018 -t 08:00:00 -p core -n 4 --reservation=g2018018_FRI
 {% endhighlight %} 
</details>  
<br />
...
{% highlight bash %}
ll -h  /proj/g2018018/nobackup/<username>/transcriptome/bams/*.bam
...
{% highlight bash %}
ll -h /proj/g2018018/nobackup/<username>/transcriptome/DE/table*
...
lrwxrwxrwx 1 olga olga   55 Nov 29 16:30 tableCounts -> /proj/g2018018/nobackup/<username>/transcriptome/featurecounts/tableCounts
