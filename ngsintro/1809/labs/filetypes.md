...
$ cp -r /sw/share/compstore/courses/ngsintro/filetypes /proj/g2018018/nobackup/<username>/
```

Have a look in **/proj/g2018018/nobackup/\<username\>/:**

```bash
$ cd /proj/g2018018/nobackup/<username>/filetypes
$ tree
```
