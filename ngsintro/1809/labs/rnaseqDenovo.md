...
The data is obtained from mouse dendritic cells (mouse_left.fasta and mouse_right.fasta and) and a whitefly (whitefly_both.fasta), and the files are located in `/sw/share/compstore/courses/ngsintro/transcriptome_assembly/`.
