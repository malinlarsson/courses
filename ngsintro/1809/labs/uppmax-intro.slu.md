...
```bash
$ interactive -A g2018018 -t 05:00:00 -p core -n 1
```
...
$ mkdir /proj/g2018018/nobackup/<username>/uppmax_tutorial
```

or

```bash
$ mkdir -p /proj/g2018018/nobackup/<username>/uppmax_tutorial
```
...
$ cp -r /sw/share/compstore/courses/ngsintro/uppmax_tutorial/* /proj/g2018018/nobackup/<username>/uppmax_tutorial
```
