...
```bash
table_annovar.pl MERGED.illumina.low_coverage.17q.filtered.vcf /sw/apps/bioinfo/annovar/2014.11.12/rackham/humandb/ -buildver hg19 -outfile myanno -vcfinput --protocol refGene -operation g
```
