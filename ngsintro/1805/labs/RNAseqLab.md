...
{% highlight bash %}
cp -r /sw/courses/ngsintro/rnaseq/main/star/SRR3222410/ /proj/g2018009/nobackup/<username>/transcriptome/star/
{% endhighlight %}
</details>
...
do
  cp -r /sw/courses/ngsintro/rnaseq/main/star/$i /proj/g2018009/nobackup/<username>/transcriptome/star/
done
{% endhighlight %}
</details>
<br />
...
{% highlight bash %}
cp /sw/courses/ngsintro/rnaseq/main/bams/out/SRR3222410_Aligned.out.bam /proj/g2018009/nobackup/<username>/transcriptome/bams/
{% endhighlight %}
</details>
<details>
...
{% highlight bash %}
for i in SRR3222411 SRR3222412 SRR3222413 SRR3222414
  do cp "/sw/courses/ngsintro/rnaseq/main/bams/out/"$i"_Aligned.out.bam" /proj/g2018009/nobackup/<username>/transcriptome/bams/ 
done
{% endhighlight %}
</details>
<br />
...
<summary>:key: Click to see how to copy over sample by sample</summary>
{% highlight bash %}
cp /sw/courses/ngsintro/rnaseq/main/bams/out/SRR3222410_Aligned.out.sorted.bam /proj/g2018009/nobackup/<username>/transcriptome/bams/
{% endhighlight %}
</details>
<details>
...
{% highlight bash %}
for i in SRR3222411 SRR3222412 SRR3222413 SRR3222414 
  do cp "/sw/courses/ngsintro/rnaseq/main/bams/out/"$i"_Aligned.out.sorted.bam" /proj/g2018009/nobackup/<username>/transcriptome/bams/
done
{% endhighlight %}
</details>
<br />
...
{% highlight bash %}
cp -r /sw/courses/ngsintro/rnaseq/main/qualimap/SRR3222410 /proj/g2018009/nobackup/<username>/transcriptome/qualimap/
{% endhighlight %}
</details>
<details>
...
for i in SRR3222409 SRR3222410 SRR3222411 SRR3222412 SRR3222413 SRR3222414
  do cp -r "/sw/courses/ngsintro/rnaseq/main/qualimap"/$i /proj/g2018009/nobackup/<username>/transcriptome/qualimap/
done
{% endhighlight %}
</details>
<br />
...
<summary>:key: Click to see an example of a command</summary>
{% highlight bash %}
cp -r /sw/courses/ngsintro/rnaseq/bonus/funannot/ /proj/g2018009/nobackup/<username>/transcriptome/
{% endhighlight %}
</details>
<br />
...
<summary>:key: Click to see an example of a command</summary>
{% highlight bash %}
cp -r /sw/courses/ngsintro/rnaseq/bonus/exon /proj/g2018009/nobackup/<username>/transcriptome
{% endhighlight %}
</details>
<br />
...
{% highlight bash %}
scp username@milou.uppmax.uu.se:/proj/g2018009/nobackup/<username>/transcriptome/bamfile.bam .
{% endhighlight %}
...
{% highlight bash %}
scp username@milou.uppmax.uu.se:/proj/g2018009/nobackup/<username>/transcriptome/DE/coverage.pdf .
{% endhighlight %}
...
cp /sw/courses/ngsintro/rnaseq/bonus/assembly/*.fasta /proj/g2018009/nobackup/<username>/transcriptome/trinity/
{% endhighlight %}
</details>
<br />
