...
{% highlight bash %}
salloc -A g2018009 -t 08:00:00 -p core -n 4 --reservation=g2018009_THU
{% endhighlight %} 
</details>  
<details>
<summary>:key: Click to see how to book a node on Friday</summary>
{% highlight bash %}
salloc -A g2018009 -t 08:00:00 -p core -n 4 --reservation=g2018009_FRI
 {% endhighlight %} 
</details>  
<br />
...
{% highlight bash %}
ll -h  /proj/g2018009/nobackup/<username>/transcriptome/bams/*.bam
...
:computer: **Navigate** to _transcriptome_ directory and *load module MultiQC/1.3*
<details>
<summary>:key: Click to see how </summary>
{% highlight bash %}
cd /proj/g2018009/nobackup/<username>/transcriptome
...
<details>
 ...
 {% highlight bash %}
 scp -r YOUR_LOGIN@milou.uppmax.uu.se:/sw/share/compstore/courses/ngsintro/rnaseq/bonus/funannot ./
 {% endhighlight %}
</details>
<br />
...
:computer: Method 2. Go to [Rackham-gui](https://rackham-gui.uppmax.uu.se/main/)
...
Each cluster represents the full transcriptional complexity for a given gene (or sets of genes that share sequences in common).
...
The data is obtained from mouse dendritic cells (mouse\_left.fasta and mouse\_right.fasta and) and a whitefly (whitefly_both.fasta), and the files are located in `/sw/share/compstore/courses/ngsintro/rnaseq/bonus/assembly`.
