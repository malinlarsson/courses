...
```
$ salloc -A g2018009 -t 07:00:00 -p core -n 1 --no-shell --reservation=g2018009_1 &
```
...
The absolute path to the course's nobackup folder would be **/proj/g2018009/nobackup**
...
```
$ mkdir /proj/g2018009/nobackup/<username>
$ mkdir /proj/g2018009/nobackup/<username>/linux_tutorial
```

or

```
$ mkdir -p /proj/g2018009/nobackup/<username>/linux_tutorial
```
...
$ cp -r /sw/share/compstore/courses/ngsintro/linux_tutorial/* /proj/g2018009/nobackup/<username>/linux_tutorial
```
...
$ wget -P /proj/g2018009/nobackup/<username>/linux_tutorial {{site.url}}/ngsintro/1502/labs/files/linux-intro/files.tar.gz
```
...
```
$ cd /proj/g2018009/nobackup/<username>/linux_tutorial
...
total 512
drwxrwsr-x 12 valent g2018009   2048 Sep 24 13:19 .
drwxrwsr-x  6 valent g2018009   2048 Sep 24 13:19 ..
drwxrwsr-x  2 valent g2018009   2048 Sep 19  2012 a_strange_name
drwxrwsr-x  2 valent g2018009   2048 Sep 19  2012 backed_up_proj_folder
drwxrwsr-x  2 valent g2018009   2048 Sep 19  2012 external_hdd
-rwxrwxr-x  1 valent g2018009  17198 Sep 24 13:19 files.tar.gz
drwxrwsr-x  2 valent g2018009   2048 Sep 19  2012 important_results
drwxrwsr-x  2 valent g2018009 129024 Sep 19  2012 many_files
drwxrwsr-x  2 valent g2018009   2048 Sep 19  2012 old_project
-rwxrwxr-x  1 valent g2018009      0 Sep 24 13:19 other_file.old
drwxrwsr-x  2 valent g2018009   2048 Sep 19  2012 part_1
drwxrwsr-x  2 valent g2018009   2048 Sep 19  2012 part_2
drwxrwsr-x  2 valent g2018009   2048 Jan 28  2012 this_has_a_file
drwxrwsr-x  2 valent g2018009   2048 Jan 28  2012 this_is_empty
-rwxrwxr-x  1 valent g2018009      0 Sep 19  2012 useless_file
...
total 0
-rwxrwxr-x 1 valent g2018009 0 Sep 19  2012 dna_data_analysis_result_file_that_is_important-you_should_really_use_tab_completion_for_file_names.bam
-rwxrwxr-x 1 valent g2018009 0 Sep 19  2012 temp_file-1
-rwxrwxr-x 1 valent g2018009 0 Sep 19  2012 temp_file-2
[valent@milou2 linux_tutorial]$
```
...
total 0
-rwxrwxr-x 1 valent g2018009 0 Sep 19  2012 dna_data_analysis_result_file_that_is_important-you_should_really_use_tab_completion_for_file_names.bam
-rwxrwxr-x 1 valent g2018009 0 Sep 19  2012 last_years_data
-rwxrwxr-x 1 valent g2018009 0 Sep 19  2012 temp_file-1
[valent@milou2 linux_tutorial]$
```
...
total 448
drwxrwsr-x 2 valent g2018009   2048 Sep 19  2012 a_better_name
drwxrwsr-x 2 valent g2018009   2048 Sep 24 13:40 backed_up_proj_folder
drwxrwsr-x 2 valent g2018009   2048 Sep 19  2012 external_hdd
-rwxrwxr-x 1 valent g2018009  17198 Sep 24 13:36 files.tar.gz
drwxrwsr-x 2 valent g2018009   2048 Sep 24 13:40 important_results
drwxrwsr-x 2 valent g2018009 129024 Sep 19  2012 many_files
drwxrwsr-x 2 valent g2018009   2048 Sep 19  2012 old_project
-rwxrwxr-x 1 valent g2018009      0 Sep 24 13:36 other_file.old
drwxrwsr-x 2 valent g2018009   2048 Sep 19  2012 part_1
drwxrwsr-x 2 valent g2018009   2048 Sep 19  2012 part_2
drwxrwsr-x 2 valent g2018009   2048 Jan 28  2012 this_has_a_file
drwxrwsr-x 2 valent g2018009   2048 Jan 28  2012 this_is_empty
...
total 0
-rwxrwxr-x 1 valent g2018009 0 Sep 24 13:46 last_years_data
[valent@milou2 linux_tutorial]$
```
## 7. Deleting Files
...
drwxrwsr-x 2 valent g2018009   2048 Sep 19  2012 a_better_name
drwxrwsr-x 2 valent g2018009   2048 Sep 24 13:40 backed_up_proj_folder
drwxrwsr-x 2 valent g2018009   2048 Sep 24 13:46 external_hdd
-rwxrwxr-x 1 valent g2018009  17198 Sep 24 13:36 files.tar.gz
drwxrwsr-x 2 valent g2018009   2048 Sep 24 13:40 important_results
drwxrwsr-x 2 valent g2018009 129024 Sep 19  2012 many_files
drwxrwsr-x 2 valent g2018009   2048 Sep 19  2012 old_project
...
total 0
-rwxrwxr-x 1 valent g2018009 0 Jan 28  2012 file
[valent@milou2 linux_tutorial]$
```
...
total 96
-rwxrwxr-x 1 valent g2018009 39904 Sep 19  2012 a
-rwxrwxr-x 1 valent g2018009     0 Sep 19  2012 stuff_1
-rwxrwxr-x 1 valent g2018009  1008 Sep 19  2012 the_best
[valent@milou2 linux_tutorial]$
```
...
total 0
-rwxrwxr-x 1 valent g2018009 0 Sep 19  2012 file_1.txt
-rwxrwxr-x 1 valent g2018009 0 Sep 19  2012 file_2.txt
[valent@milou2 linux_tutorial]$ ll part_2
total 0
-rwxrwxr-x 1 valent g2018009 0 Sep 19  2012 file_3.txt
-rwxrwxr-x 1 valent g2018009 0 Sep 19  2012 file_4.txt
-rwxrwxr-x 1 valent g2018009 0 Sep 19  2012 garbage.tmp
-rwxrwxr-x 1 valent g2018009 0 Sep 19  2012 incomplete_datasets.dat
[valent@milou2 linux_tutorial]$
```
