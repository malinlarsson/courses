...
{% highlight bash %}
salloc -A g2018002 -t 08:00:00 -p core -n 4 --reservation=g2018002_THU
{% endhighlight %} 
</details>  
<details>
<summary>:key: Click to see how to book a node on Friday</summary>
{% highlight bash %}
salloc -A g2018002 -t 08:00:00 -p core -n 4 --reservation=g2018002_FRI
 {% endhighlight %} 
</details>  
<br />
...
<summary>:key: Click to see suggested commands</summary>
{% highlight bash %}
cd /proj/g2018002/nobackup/<username>/transcriptome/DATA/
...
{% highlight bash %}
cp -r /sw/courses/ngsintro/rnaseq/main/star/SRR3222410/ /proj/g2018002/nobackup/<username>/transcriptome/star/
{% endhighlight %}
</details>
...
do
cp -r /sw/courses/ngsintro/rnaseq/main/star/$i /proj/g2018002/nobackup/<username>/transcriptome/star/
done
{% endhighlight %}
</details>
<br />
...
{% highlight bash %}
cp /sw/courses/ngsintro/rnaseq/main/bams/out/SRR3222410_Aligned.out.bam /proj/g2018002/nobackup/<username>/transcriptome/bams/
{% endhighlight %}
</details>
<details>
...
{% highlight bash %}
for i in SRR3222411 SRR3222412 SRR3222413 SRR3222414
do cp "/sw/courses/ngsintro/rnaseq/main/bams/out/"$i"_Aligned.out.bam" /proj/g2018002/nobackup/<username>/transcriptome/bams/ 
done
{% endhighlight %}
</details>
<br />
...
<summary>:key: Click to see how to copy over sample by sample</summary>
{% highlight bash %}
cp /sw/courses/ngsintro/rnaseq/main/bams/out/SRR3222410_Aligned.out.sorted.bam /proj/g2018002/nobackup/<username>/transcriptome/bams/
{% endhighlight %}
</details>
<details>
...
{% highlight bash %}
for i in SRR3222411 SRR3222412 SRR3222413 SRR3222414 
do cp "/sw/courses/ngsintro/rnaseq/main/bams/out/"$i"_Aligned.out.sorted.bam" /proj/g2018002/nobackup/<username>/transcriptome/bams/
done
{% endhighlight %}
</details>
<br />
...
{% highlight bash %}
cp -r /sw/courses/ngsintro/rnaseq/main/qualimap/SRR3222410 /proj/g2018002/nobackup/<username>/transcriptome/qualimap/
{% endhighlight %}
</details>
<details>
...
do cp -r "/sw/courses/ngsintro/rnaseq/main/qualimap"/$i /proj/g2018002/nobackup/<username>/transcriptome/qualimap/
done
{% endhighlight %}
</details>
<br />
...
<summary>:key: Click to see an example of a command</summary>
{% highlight bash %}
cp -r /sw/courses/ngsintro/rnaseq/bonus/funannot/ /proj/g2018002/nobackup/<username>/transcriptome/
{% endhighlight %}
</details>
<br />
...
<summary>:key: Click to see an example of a command</summary>
{% highlight bash %}
cp -r /sw/courses/ngsintro/rnaseq/bonus/exon /proj/g2018002/nobackup/<username>/transcriptome
{% endhighlight %}
</details>
<br />
...
The data is obtained from mouse dendritic cells (mouse\_left.fasta and mouse\_right.fasta and) and a whitefly (whitefly_both.fasta), and the files are located in `/sw/courses/ngsintro/rnaseq/bonus/assembly`.
...
cp /sw/courses/ngsintro/rnaseq/bonus/assembly/*.fasta /proj/g2018002/nobackup/<username>/transcriptome/trinity/
{% endhighlight %}
</details>
<br />
