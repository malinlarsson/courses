...
{% highlight bash %}
cd /proj/g2018002/nobackup/<username>/<username>
mkdir transcriptome
...
{% highlight bash %}
scp username@milou.uppmax.uu.se:/proj/g2018002/nobackup/<username>/transcriptome/bamfile.bam .
{% endhighlight %}
...
{% highlight bash %}
scp username@milou.uppmax.uu.se:/proj/g2018002/nobackup/<username>/transcriptome/DE/coverage.pdf .
{% endhighlight %}
