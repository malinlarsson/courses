...
{% highlight bash %}
salloc -A g2016028 -t 08:00:00 -p core -n 8 --no-shell --reservation=g2016028_THU &
{% endhighlight %} 
</details>  
<details>
...
{% highlight bash %}
ll -h ~/glob/transcriptome/reference/
...
{% highlight bash %}
ll -h ~/glob/transcriptome/indexChr11
...
{% highlight bash %}
ll -h  ~/glob/transcriptome/bams/*.sam
...
{% highlight bash %}
ll -h  ~/glob/transcriptome/bams/*.bam
...
{% highlight bash %}
ll -h  ~/glob/transcriptome/bams/*.sorted.bam
...
{% highlight bash %}
for i in  ~/glob/transcriptome/bams/*.sorted.bam
do samtools index $i
done
{% endhighlight %}
</details>
...
{% highlight bash %}
ll -h  ~/glob/transcriptome/bams/*.bai
...
{% highlight bash %}
ll -h ~/glob/transcriptome/qualimap/SRR3222409/
...
{% highlight bash %}
ll -h ~/glob/transcriptome/DE/table*
...
{% highlight bash %}
ll -h ~/glob/transcriptome/DE

-rw-rw-r-- 1 olga olga 8.9M Nov 29 16:31 DEdata.RData
lrwxrwxrwx 1 olga olga   50 Nov 29 16:30 diffExp.R -> /sw/courses/ngsintro/rnaseq_2016/main/DE/diffExp.R
...
lrwxrwxrwx 1 olga olga   68 Nov 29 16:30 tableCounts_annotations.txt -> /sw/courses/ngsintro/rnaseq_2016/main/DE/tableCounts_annotations.txt
{% endhighlight %}
<br/>
