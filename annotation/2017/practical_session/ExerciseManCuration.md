...
In this case the bes is to investigate and eliminate the issue(s) from the raw data and re-run the pipeline. Examples would be poorly assembled RNA-seq data or incompletely or badly sampled protein data. Another issue may be severe problems with the genome assembly. This of course is outside of your annotation task - and a discussion with the assembly team may be necessary.
...
- Maker\_withn\_no\_abinitio : A maker annotation using Ab initio and Evidence-based approach.  
...
<br/>Ludovic :             488 500	- 575 500
<br/>Topi :                575 500	- 662 500
<br/>Mahwash	:            662 500	- 749 500
<br/>Lihong	:              749 500	- 836 500
<br/>Suvi	:                836 500	- 923 500
<br/>Carina	:              923 500	- 1 010 500
<br/>Karin	:              1 010 500	- 1 097 500 
<br/>Chao :                1 097 500 - 1 184 500
<br/>Mi :                  1 184 500 - 1 268 000
